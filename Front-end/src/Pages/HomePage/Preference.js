        ...
        <Layout>
            ...
            <div className="container">
                ...
                <div className="Preference-buttons">
                    <button className={webdev.join(' ')} onClick={()=> this.categoryHandler("Web Development")}>Learning Topic 1</button>
                    <button className={pl.join(' ')} onClick={()=> this.categoryHandler("Programming Languages")}>Learning Topic 2</button>
                    <button className={ml.join(' ')} onClick={()=> this.categoryHandler("AI / ML")}>Learning Topic 3</button>
                    <button className={cd.join(' ')} onClick={()=> this.categoryHandler("Cloud Development")}>Learning Topic 4</button>
                    <button className={ds.join(' ')} onClick={()=> this.categoryHandler("Data Science")}>Learning Topic 5</button>
