...
const Navbar = ()=>{
      ...
      <li className="nav-item" data-toggle="tooltip" data-placement="top"
       title="Create Your Course">
        ...
        <NavLink to="/teacherhome" activeClassName="teacherActive"
         className="nav-link teachLink">Create Topic</NavLink>
      </li>
    
     
      <li className="nav-item">
        <NavLink to="/Cart" className="nav-link "> 
        <i data-toggle="tooltip" data-placement="top" title="Bookmarked Topics"
  ...
  return(
    ...
    <NavLink to="/menu" className="navbar-brand"><Logo/></NavLink>
